package com.adward.ad.index.keyword;

import com.adward.ad.index.IndexAware;
...
public class UnitKeywordIndex implements IndexAware<String, Set<Long>> {
    ...
    /**
     * TODO
     * key value--------->  {key: 奥迪, value: {1,2,3}}
     * key value--------->  {key: 宝马, value: {2,3,5}}
     * 既要删除关键字所对应的ids，也要从对应的ids中删除关键字
     */
    @Override
