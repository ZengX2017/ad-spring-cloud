package com.adward.ad.handler;

import com.adward.ad.dump.table.*;
import com.adward.ad.index.DataTable;
import com.adward.ad.index.IndexAware;
import com.adward.ad.index.adplan.AdPlanIndex;
import com.adward.ad.index.adplan.AdPlanObject;
import com.adward.ad.index.adunit.AdUnitIndex;
import com.adward.ad.index.adunit.AdUnitObject;
import com.adward.ad.index.creative.CreativeIndex;
import com.adward.ad.index.creative.CreativeObject;
import com.adward.ad.index.creativeunit.CreativeUnitIndex;
import com.adward.ad.index.creativeunit.CreativeUnitObject;
import com.adward.ad.index.district.UnitDistrictIndex;
import com.adward.ad.index.interest.UnitItIndex;
import com.adward.ad.index.keyword.UnitKeywordIndex;
...
public class AdLevelDataHandler {
    ...
    public static void handleLevel4(AdUnitKeywordTable keywordTable,
        ...
        Set<Long> value = new HashSet<>(
                Collections.singleton(keywordTable.getUnitId()) //构造一个元素的集合
        );
        handleBinlogEvent(
